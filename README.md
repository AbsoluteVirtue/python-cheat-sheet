...
4. Functions, def, return, variable scope, try-except
5. Debugging, assert, logging, tests
6. Lists, tuples, strings, list methods, short-circuit eval, references
7. Dictionaries, dict, key-value pair, methods
8. Text processing, string literals, f-strings, methods, ord, chr, Pyperclip
9. Text matching, regular expressions, greedy matching, re.compile, Humre
10. Files, pathlib, Path, open, shelve, with
11. File processing, move, copy, delete, zipfile, os.walk, shutil
12. CLI, running python programs, venv, PyMsgBox, PyInstaller
13. Web scraping, HTTP, Requests, Beautiful Soup, Selenium, Playwright, headless mode
14. Excel spreadsheets, OpenPyXL, operations
15. Google sheets, EZSheets, Google Forms
16. SQLite, type affinity, CRUD, foreign keys, table joins, transactions
17. PDF/Word docs
18. CSV, JSON, XML files, csv.DictReader, csv.DictWriter
19. Time, scheduling, system clock, datetime, timedelta, running programs from scripts
20. Email, push notifications, Gmail API, SMS gateways
21. Graphs and images, pixels and colors, Pillow, Matplotlib
