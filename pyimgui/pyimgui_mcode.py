...
# imgui functions accept conditions argument. 
# It allows you to specify when values/procedures specified by given API function should be applied:
#   imgui.ALWAYS
#   imgui.ONCE
#   imgui.FIRST_USE_EVER
#   imgui.APPEARING

# New windows created using begin() function can be customized/tuned with additional flags argument. 
# This argument is an integer bitfield so many different flags can be joined together with | operator.
#   imgui.begin(
#       "Custom window",
#       flags=imgui.WINDOW_MENU_BAR
#   )
