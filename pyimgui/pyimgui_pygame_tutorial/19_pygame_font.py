...
def main():
    ...
    # Set screen title
    pygame.display.set_caption("Pyimgui: 19_font")
    ...
    while 1:
        ...
        if imgui.button("Bigger font"):
            # ... every font in this window will be twice as large.
            imgui.set_window_font_scale(2.0)

        # If the button is clicked ...
        if imgui.button("Default font size"):
            # ... every font in this window gets the default size
